...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2024 at 02:54 AM
...
(3, '2024-09-05', 2, '2', 1, '2024-09-05 09:33:42', NULL, NULL, NULL, NULL, '2024-09-05 07:33:42');
...
(6, 3, 7, 1, 3, 250000, 120, 1, '0000-00-00', 1, '2024-09-06 04:52:10', 1, '2024-09-06 06:07:31', NULL, NULL, '2024-09-06 04:07:31'),
(7, 3, 2, 50, 2, 480000, 50, 2, '2024-09-06', 1, '2024-09-06 05:35:17', 1, '2024-09-06 09:26:27', NULL, NULL, '2024-09-06 07:26:27'),
(8, 3, 4, 1, 4, 250000, 20, 2, '0000-00-00', 1, '2024-09-06 06:03:25', 1, '2024-09-06 09:25:58', NULL, NULL, '2024-09-06 07:25:58'),
(9, 3, 5, 1, 3, 300000, 10, 1, NULL, 1, '2024-09-06 06:39:03', NULL, NULL, NULL, NULL, '2024-09-06 04:39:03');
...
(29, 9, 2024, 2, 2, 3, 50, 0, 0, '2024-09-06 03:39:08'),
(30, 9, 2024, 3, 1, 3, 0, 0, 0, '2024-09-05 06:03:20'),
(31, 9, 2024, 4, 2, 3, 20, 0, 0, '2024-09-06 04:03:25'),
(32, 9, 2024, 5, 1, 3, 10, 0, 0, '2024-09-06 04:39:03'),
(33, 9, 2024, 6, 1, 3, 0, 0, 0, '2024-09-05 06:03:20'),
(34, 9, 2024, 7, 1, 3, 120, 0, 0, '2024-09-06 04:07:12'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_produk`  AS SELECT `produk`.`id` AS `id`, `kategori_produk`.`nama` AS `kategori_produk`, `produk`.`barcode` AS `barcode`, `produk`.`nama` AS `produk`, `satuan`.`nama` AS `satuan`, concat(`kategori_produk`.`nama`,' ',`produk`.`nama`) AS `detail_produk`, `akun`.`akun` AS `created_by`, `produk`.`created_at` AS `created_at`, `produk`.`delete_by` AS `delete_by`, `produk`.`delete_at` AS `delete_at`, `produk`.`log` AS `log` FROM (((`produk` join `kategori_produk` on(`kategori_produk`.`id` = `produk`.`kategori_produk`)) join `akun` on(`akun`.`id` = `produk`.`created_by`)) join `satuan` on(`satuan`.`id` = `produk`.`satuan`)) ORDER BY `produk`.`log` DESC ;
