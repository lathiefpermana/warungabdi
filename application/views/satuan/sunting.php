                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="text-muted breadcrumb-item" aria-current="page">Sunting Satuan</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-3">
                                Sunting satuan merupakan proses melakukan perubahan pada data satuan yang sudah dipilih.
                            </p>

                            <form class="was-validated" method="post" action="<?= base_url('satuan/pembaruan'); ?>">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3" hidden>
                                            <label class="form-label" for="validationCustom01">ID</label>
                                            <input type="text" class="form-control" id="validationCustom01" name="id" value="<?= $satuan['id'] ?>" required>
                                            <div class="invalid-feedback">Harus diisi</div>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label class="form-label" for="validationCustom01">Nama</label>
                                            <input type="text" class="form-control" id="validationCustom01" name="nama" value="<?= $satuan['nama']; ?>" required="">
                                            <div class="invalid-feedback">Harus diisi</div>
                                        </div>
                                    </div>
                                </div>
