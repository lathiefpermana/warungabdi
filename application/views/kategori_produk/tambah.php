                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="text-muted breadcrumb-item" aria-current="page">Tambah Kategori Produk</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-3">
                                Tambah kategori produk merupakan menambahkan data induk daripada produk - produk.
                            </p>

                            <form class="was-validated" method="post" action="<?= base_url('kategori_produk/simpan'); ?>">
                                <div class="row">
                                    <div class="col-md-4">
