                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="text-muted breadcrumb-item" aria-current="page">Tambah Tipe</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-2">
                                <h5 class="card-title">
                                    Tambah Tipe <i>Cash Flow</i>
                                </h5>
                            </div>
                            <p class="card-subtitle mb-3">
                                Tambah tipe <i>cash flow</i> untuk menentukan kategori masuk atau keluar <i>cash</i>.
                            </p>

                            <form class="was-validated" method="post" action="<?= base_url('tipe_cash_flow/simpan'); ?>">
                                <div class="row">
                                    <div class="col-md-4">
